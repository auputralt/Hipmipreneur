    ...
    <div className="px-6 py-6 max-w-[1400px] mx-auto w-full flex flex-col gap-6 relative font-sans">
      ...
      <header className="border-b border-outline-glow/30 pb-4 shrink-0">
        <div className="flex items-center gap-2 text-secondary mb-1 font-mono text-[9px] tracking-wider uppercase">
          <span className="material-symbols-outlined text-[10px]">note_alt</span>
          <span>Operations // Notes</span>
        </div>
        <h1 className="font-headline text-2xl font-bold text-on-surface">Venture Notes</h1>
        <p className="font-body text-xs text-on-surface-variant mt-1">
          Jot down free-form ideas, draft hypotheses, and capture team brainstorming sessions.
        </p>
      </header>
      ...
      <div className="w-full glass-panel border border-outline-glow rounded-xl p-10 text-center flex flex-col items-center justify-center gap-6 h-[400px] relative overflow-hidden">
        ...
        <div className="relative">
          <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-primary to-secondary flex items-center justify-center shadow-[0_0_20px_rgba(128,131,255,0.3)] animate-pulse">
            <span className="material-symbols-outlined text-surface-dim font-bold text-3xl">note_alt</span>
          </div>
        ...
        <div className="space-y-2 w-[450px] max-w-full relative z-10">
          <h3 className="font-headline font-bold text-primary text-sm uppercase tracking-wider font-mono">Notes Module Coming Soon</h3>
          <p className="text-xs text-on-surface-variant leading-relaxed font-body">
            Kami sedang membangun editor teks kolaboratif kaya fitur. Modul ini akan memungkinkan Anda menulis catatan rapat, menandai sesama co-founder, menautkan catatan langsung ke segmen kanvas tertentu, dan menyusun hipotesis sebelum melakukan wawancara riset.
          </p>
        </div>
